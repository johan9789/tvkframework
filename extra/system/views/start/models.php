<div class="container">    
    ...
    <span id="first_action" class="<?php echo App::base('extra/model/create_active_record'); ?>"></span>
    <span id="second_action" class="<?php echo App::base('extra/model/create_relational_static'); ?>"></span>
    <span id="third_action" class="<?php echo App::base('extra/model/create_relational_inherited'); ?>"></span>
    <section>
        <h4>
