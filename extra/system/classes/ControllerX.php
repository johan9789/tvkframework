...
class ControllerX {
    ...
    public function active_record($name_crud, $mayus_name_crud, $table_crud, $mayus_table_crud, $pk_table, $fields_table, $ya_existe_crud){
        ...
        if(file_exists("../app/controllers/$mayus_name_crud.php")){
            exit($ya_existe_crud);
        }
        // Seguimos...
        $fc = fopen("../app/controllers/$mayus_name_crud.php", 'a');
        $con = '<?php';
        $con.= "\n";
        ...
        $con.= "        ".'$this->load('."'$mayus_table_crud'".');'."\n";
        $con.= "    }";
        $con.= "\n";
        $con.= "\n";
        $con.= "    public function index(){\n";
        $con.= '        $data_'."$table_crud".' = '."$mayus_table_crud".'::all();'."\n";
        ...
        if($pk_table != ""){
            ...
            $con.= '        }'."\n";
            $con.= '        $data_'."$table_crud".' = '."$mayus_table_crud".'::all();'."\n";
            $con.= '        $data_'."$table_crud".'_edit = '."$mayus_table_crud".'::findOne($id);'."\n";
        ...
        foreach($fields_table as $fields_t){
            ...
            $con.= '            $'."$table_crud"."->".$fields_t." = ".'$insert'."['".replace_special_chars($fields_t)."'];"."\n";
        }
        ...
        if($pk_table != ""){
            ...
            foreach($fields_table as $fields_t){
                ...
                $con.= '            $'."$table_crud"."->".$fields_t." = ".'$update'."['".replace_special_chars($fields_t)."'];"."\n";
            }
